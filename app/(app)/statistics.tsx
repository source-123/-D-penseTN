...
import {
  buildCategorySlices, buildMonthlyTrend,
  type CategorySlice, type MonthPoint,
...
export default function Statistics() {
  ...
  const totalExpenses = currentSlices.reduce((s: number, sl: CategorySlice) => s + sl.total, 0);
  ...
  const pieData = currentSlices.map((s: CategorySlice) => ({
    name: s.name,
    population: s.total,
    color: s.color,
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Visualise tes dépenses</Text>
        </View>
        ...
        <View style={styles.totalBox}>
          <Text style={styles.totalLabel}>Dépenses totales du mois</Text>
        ...
        {currentSlices.length === 0 ? (
          ...
          <>
            ...
            <View style={styles.chartCard}>
              <Text style={styles.chartTitle}>Détail</Text>
              {currentSlices.map((s: CategorySlice) => (
